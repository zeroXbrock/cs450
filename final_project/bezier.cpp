...
// helper function takes 3D vector instead of discrete RGB floats
void drawEazierCurve(float colors[3], Curve c){
    drawBezierCurve(colors[0], colors[1], colors[2], c);
}
...
void placeLeg(Curve *c, float x = 0., float y = 0., float z = 0., float xx = 1., float yy = 1., float zz = 1.){
    Point p0, p1, p2, p3;
    p0.x0 = x;
    p0.y0 = y;
    p0.z0 = z;
