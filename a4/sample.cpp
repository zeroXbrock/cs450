...
#define MS_IN_ANIMATION_CYCLE 5000
...
const char *WINDOWTITLE = { "OpenGL / GLUT Sample -- Joe Graphics x Brock Smedley" };
...
GLuint 	LamboList;				// object display list
...
void drawBoxFlat(float x, float y, float z) {
...
void drawBoxSmooth(float x, float y, float z)
{
	float dx = BOXSIZE / 2.f;
	float dy = BOXSIZE / 2.f;
	float dz = BOXSIZE / 2.f;
